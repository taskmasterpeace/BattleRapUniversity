            ...
            {list.map((b) => {
              ...
              return (
                <Link
                  key={b.id}
                  href={`/battler/${b.id}`}
                  className="group bg-[#18191c] border-2 border-[#3a3d44] hover:border-[#ff8c42] hover:-translate-y-[2px] hover:shadow-[0_10px_30px_-15px_rgba(255,140,66,0.6)] transition-all duration-200 block overflow-hidden"
                >
                  {/* Avatar */}
                  <div
