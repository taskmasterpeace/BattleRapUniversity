/**
 * The house icon set — inline SVG, stroke-based, Lucide-style.
 *
 * One art language for UI chrome: pixel sprites are for the WORLD (people,
 * cities, badges, crowds); these stroke icons are for the INTERFACE. Emoji
 * are for neither — they render inconsistently across platforms and clash
 * with both. If you're about to type an emoji into a component, add an icon
 * here instead.
 */
