...
function FighterCol({ f, tag }: { f: FlyerFighter; tag: string }) {
  const src = f.portrait || "/sprites/characters/sprite_569.png"
  return (
...
export function TaleOfTheTape({ a, b, stats }: TaleOfTheTapeProps) {
  const aSrc = a.portrait || "/sprites/characters/sprite_571.png"
  const bSrc = b.portrait || "/sprites/characters/sprite_655.png"
  return (
